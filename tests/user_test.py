...
def test_adding_user(application):
    ...
    with application.app_context():
        ...
        # create a record
        user = User('akshaypujare@gmail.com', 'testtest')
        ...
        user = User.query.filter_by(email='akshaypujare@gmail.com').first()
        log.info(user)
        # asserting that the user retrieved is correct
        assert user.email == 'akshaypujare@gmail.com'
